<template>
  <div id="select">
    ...
    <ul v-if="current == 2">
      <li class="A" :class="{wrong: wrongs.A,checked:answer=='A'}" @click="checked('A')">{{ question.options.A }}</li>
      <li class="B" :class="{wrong: wrongs.B,checked:answer=='B'}" @click="checked('B')">{{ question.options.B }}</li>
      <li class="C" :class="{wrong: wrongs.C,checked:answer=='C'}" @click="checked('C')">{{ question.options.C }}</li>
      <li class="D" :class="{wrong: wrongs.D,checked:answer=='D'}" @click="checked('D')">{{ question.options.D }}</li>
    </ul>
    <p class="btn-wrap">
